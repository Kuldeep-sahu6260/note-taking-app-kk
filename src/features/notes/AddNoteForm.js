      ...
      <section className='pl-[36px] pr-[36px] py-[24px] rounded-[4px] m-[12px] [box-shadow:rgba(0,_0,_0,_0.06)_0px_1px_9px]'>
        ...
        <form className='max-w-[480px]'>
          <div className='mb-[14px]'>
            ...
            <input type = "text" id = "noteTitle" name = "noteTitle" placeholder='Note title here ...' onChange={onFormDataChange} className='border-1 border-slate-300 border-solid px-4 py-[0.7rem] w-full rounded-[2px] text-[14px] font-light opacity-90 leading-[1.6]' value = {formData.noteTitle} />
          ...
          <div className='mb-[14px]'>
            ...
            <textarea id = "noteContent" name = "noteContent" placeholder='Note content here ...' onChange={onFormDataChange} className='border-1 border-solid border-slate-300 px-4 py-[0.7rem] w-full rounded-[2px] text-[14px] font-light opacity-90 leading-[1.6]' rows = "10" value = {formData.noteContent}></textarea>
